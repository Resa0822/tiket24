...
/* window.onload = fnacv_btn; */
			...
			<tr class="k-alt" role="row" style="text-align: center;" >
				...
				<td class="" role="gridcell" title="<strong><?php echo $row->nominal; ?></strong><br /> <strong…<strong>Grade : </strong> 3 <strong>Status : </strong> Good"><?php echo number_format($row->nominal,2); ?></td>
