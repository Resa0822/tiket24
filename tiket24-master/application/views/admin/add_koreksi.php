...
<?php echo form_open_multipart('koreksi/add_koreksi');?>
...
<table class="form">   
	<tr class="form-row">
		...
		<td class="field">
			<?php echo form_dropdown('roles', $roles, '#', 'id="roles"'); ?>
		</td>
	</tr>
	<tr class="form-row">
		<td >Name	: 	</td>
	...
	<tr class="form-row">
        ...
        <td class="field">
            <input id="koreksi_point" type="text" title="Enter Point." size="50" value="" name="koreksi_point" dir="rtl" style="width:30%; height:30%;"></input>
		</td>
	</tr>		
</table>
