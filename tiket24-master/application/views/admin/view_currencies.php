...
<div id="grid" class="k-grid k-widget k-secondary k-reorderable" data-role="grid" style="">
    <div class="k-grouping-header" data-role="droptarget" style="padding-left:10px;"> Manage Data currencies</div>
       <div style="clear:both;"></div>
<!-- ===========search form start======== -->
	 <div class="pull-right" style="padding:5px; vertical-align:middle;">
     <form action="<?php echo base_url().'index.php/currencies/searching/' ?>" enctype="multipart/form-data" method="post">
        ...
        <thead class="k-grid-header">
            <tr>
                <th class="k-header k-with-icon" data-title="packages Name" data-field="packagess_name" role="columnheader" data-role="sortable">
                    ...
                    <a class="k-link" href="#">From Currencies Code</a>
                </th>
<!--				<th class="k-header k-with-icon" data-title="packages Name" data-field="packagess_name" role="columnheader" data-role="sortable">
                    <a class="k-header-column-menu" href="#" tabindex="-1">
                        <span class="k-icon k-i-arrowhead-s"></span>
                    </a>
                    <a class="k-link" href="#">To Currencies Code</a>
                </th> -->
                <th class="k-header k-with-icon" data-title="packages Name" data-field="packagess_name" role="columnheader" data-role="sortable">
                    <a class="k-header-column-menu" href="#" tabindex="-1">
                        <span class="k-icon k-i-arrowhead-s"></span>
		...
		{ ?>
			<tr class="k-alt" role="row" style="text-align: center;" >
				...
				<!-- <td class="" role="gridcell" title="<strong><?php //echo $row->currency_to; ?></strong><br /> <strong…<strong>Grade : </strong> 3 <strong>Status : </strong> Good"><?php //echo $row->currency_to; ?></td> -->
