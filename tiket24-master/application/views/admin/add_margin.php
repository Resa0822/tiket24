...
<table class="form">   
	...
	<tr class="form-row">
        <td >Margin(%)	:</td>
        <td class="field">
            <input id="margin_pr" type="text" maxlength="3" title="Enter Margin of Country." size="50" value="" name="margin_pr" style="width:30%; height:auto;"></input>
		</td>
	</tr>
	<tr class="form-row">
        <td >Margin(Rp)	:</td>
        <td class="field">
            <input id="margin_rp" type="text" title="Enter Margin of Country." size="50" value="" name="margin_rp" style="width:30%; height:auto;"></input>
		</td>
	</tr>	
<!--	<tr class="form-row">
        <td >Currencies:
