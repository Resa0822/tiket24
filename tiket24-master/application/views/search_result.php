...
<!--
    <h1 class="white" style="padding-left: 10px;" >Search Result</h1>
    ...
    <div id="black_heading" style="width:8%">Package</div>
 
    <div>
    	<img style=" height:3%;" src="<?php echo base_url(); ?>/asset/images/icon/flag_blue.png"> Applicablae For Cash Voucher / Discount Code
    </div>
    -->
<?php
	...
	<div id="package">
        <div id="package_list">
			...
			<div style="clear:both;"></div>
				...
				foreach($qryCekDskn->result() as $dsknRow){
					...
					if($diskon == 0){
						...
						$salePrice = round($pckgsPrice + $profit, 2);
						//$tmplHarga = '<del>from'.' '.$crrncy.' '.$priceMarkup.' / Person</del><br /><b>from'. ' SGD'.' '.$salePrice.' / Person</b>';
						$finalPrice = round((( $salePrice * $conv_sgd ) / $conv), 2);
            ...
            <div id="package_image" style="position:relative; top:50px;">
            	...
            	?>
            	<!-- START RIBBON -->
				<div class="ribbon ribbon-large ribbon-red" style="z-index: 5000">
				<div class="banner">
