...
function processing(){
	...
	$config = array(
		...
		if ($this->form_validation->run() == FALSE)
		{
			echo '<script>alert("field ada yg kosong")</script>';
...
/* input activity search price start here */	
		...
		$j= $i-1;
			...
			$adultGuest[$j] = array('Title' => $salutationTL,//$adultSalutation[$j], 
							   ...
							   'PassportExpiryDate' => $passportExpiredDateTL,//$adultPassportExpiredDate[$j],
