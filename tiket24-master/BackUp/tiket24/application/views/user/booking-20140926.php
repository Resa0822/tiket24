...
<form action="<?php echo base_url();?>index.php/transaction/userGuestBooking" method="post" enctype="multipart/form-data" />
<?php
...
<table border="0" style="width:100%;">
	...
	<td><select name="salutationTL" style="width:100px" >
...
<table border="0" width=100%>
	...
	<tr>
	<td width="200">Salutation</td>
	<td><select name="salutationTravCntc" style="width:100px">
	<option value="">&lt;Choose&gt;</option>
	<option value="Mr" >Mr</option>
	<option value="Mrs">Mrs</option>
	<option value="Mdm">Mdm</option>
	...
	<td><?php echo form_error('txtPhoneNumberTravCntc', '<div style="color:red">', '</div>'); ?><input type="text"  name="txtPhoneNumberTravCntc" style="width:100px;" placeholder="Phone Number" />
	</td>
	</tr>
	<tr>
	<td>Mobile Number</td>
	...
	<td><?php echo form_error('nationalityIdTravCntc', '<div style="color:red">', '</div>'); ?><select name="nationalityIdTravCntc" >
	<option value="">&lt;Choose Nationality&gt;</option>
	<?php
...
<!-- ==================child traveler end============= -->
		...
		<tr>
			...
			<td>
				<table>
					<tr>
					<?php
					$qryPymntMthd = mysql_query("SELECT * FROM metode_pembayaran");
					while($fldPymntMthd = mysql_fetch_array($qryPymntMthd)){
						if($fldPymntMthd['nama_metode'] == 'Credit Card'){
							$nilCheck = 'checked';
						}else{
							$nilCheck = '';
						}
					?>	
						<td style="padding:5px;"><label for="<?php echo $fldPymntMthd['kode']; ?>" style="float: left"><input type="radio" id="<?php echo $fldPymntMthd['kode']; ?>" name="paymethod" value="<?php echo $fldPymntMthd['kode']; ?>" <?php echo $nilCheck; ?> style="float: left"   /><?php echo $fldPymntMthd['deskripsi']; ?></label></td>
	...
	<?php
	$qryPymntMthd = $this->db->select('*')->from('metode_pembayaran')->where('kode !=', 'MP0001')->get();
	...
	<table border="0" width=100%>
		<tr>
		<td>&nbsp;</td>
		<td align="right"><input type="submit" name="confirmBook" value="Confirm Booking" /></td>
		</tr>
	</table>
</form>
</div>
