...
<div id="grid" class="k-grid k-widget k-secondary k-reorderable" data-role="grid" style="">
    <div class="k-grouping-header" data-role="droptarget" style="padding-left:10px;" > Manage Data city</div>
     <div style="clear:both;"></div>
<!-- ===========search form start======== -->
	 <div class="pull-right" style="padding:5px; vertical-align:middle;">
     <form action="<?php echo base_url().'index.php/packages_city/searching/' ?>" enctype="multipart/form-data" method="post">
...
$(document).ready(function(){
	$("#pcx<?php echo $row->idy; ?>").spinner({ min: 0 });
	$('.ui-spinner-button').click(function() { 
		$(this).siblings("#pcx<?php echo $row->idy; ?>").change(); 	
	});

	$("#pcx<?php echo $row->idy; ?>").spinner().change(function(){
             //alert($(this).spinner('value'));
            var platform_id = <?php echo $row->idy; ?>;
			...
			<tr class="k-alt" role="row" style="text-align: center;" >
				...
				<input type="text" id="pcx<?php echo $row->idy; ?>" value="<?php echo $row->orders; ?>" name="<?php echo "order".$row->idy; ?>" style="width: 30px;">
				<!--
