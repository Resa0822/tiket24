...
<div style="clear:both;"></div>
 echo form_open_multipart('faq/edit');?>
 <input id="kode_faq" type="hidden" value="<?php echo $isi->kode_faq; ?>" name="kode_faq"></input>
...
<table class="form">   
	<tr class="form-row">
        ...
        <td class="field">
            <textarea id="pertanyaan" font_end_label="Details" title="Enter a News." rows="5" name="pertanyaan" style="width: 100%;"><?php echo $isi->pertanyaan; ?></textarea>
		</td>
	</tr>
	<tr class="form-row">
        <td >Answer	:
        ...
        <td class="field">
            <textarea id="jawaban" font_end_label="Details" title="Enter a News." rows="5" name="jawaban" style="width: 100%;"><?php echo $isi->jawaban; ?></textarea>
		</td>
	</tr>	
</table>
