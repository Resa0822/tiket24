...
<div id="grid" class="k-grid k-widget k-secondary k-reorderable" data-role="grid" style="">
    <div class="k-grouping-header" data-role="droptarget"> &nbsp; Booking History Period <?php echo $periode; ?>
		<span class="k-pager-info k-label">
			<a href="<?php echo base_url()?>index.php/transaction/all_booking_history_by_period/prd/<?php echo $rprtPrd; ?>" target="_blank"><img style="width:60px;height:30px;"src="<?php echo base_url()?>asset/images/icon/pdf-download.png"/></a>
		</span>
	</div>
