...
<div id="grid" class="k-grid k-widget k-secondary k-reorderable" data-role="grid" style="">
    <div class="k-grouping-header" data-role="droptarget"> &nbsp; Point History Period <?php echo $periode; ?>
		<span class="k-pager-info k-label">
			<a href="<?php echo base_url()?>index.php/transaction/point_history_by_period/prd/<?php echo $rprtPrd; ?>" target="_blank"><img style="width:60px;height:30px;"src="<?php echo base_url()?>asset/images/icon/pdf-download.png"/></a>
		</span>
	</div>
 ...
 <!--       <colgroup>
        ...
        <thead class="k-grid-header">
            <tr>
                ...
                <th class="k-header k-with-icon" data-title="Date" data-field="packagess_date" role="columnheader" data-role="sortable">
                    ...
                    <a class="k-link" href="#">Point Earned</a>
                </th>
                <th class="k-header k-with-icon" data-title="Date" data-field="packagess_date" role="columnheader" data-role="sortable">
                    <a class="k-header-column-menu" href="#" tabindex="-1">
                        <span class="k-icon k-i-arrowhead-s"></span>
                    </a>
                    <a class="k-link" href="#">Point Radeemed</a>
                </th>
		...
		?>
			...
			<tr class="k-alt" role="row" style="text-align: center;" >
				...
				<td class="" role="gridcell" title="<strong><?php echo $pointEarned; ?></strong><br /> <strong…<strong>Grade : </strong> 3 <strong>Status : </strong> Good"><?php echo $pointEarned; ?></td>
				<td class="" role="gridcell" title="<strong>cetak voucher</strong><br /> <strong…<strong>Grade : </strong> 3 <strong>Status : </strong> Good">
				<?php echo $pointRademed; ?>
				</td>
