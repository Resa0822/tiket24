...
<h2> &nbsp; </h2>
	<div id="hotel-content-description"  style="text-align:center;border:10px solid #25497d; margin:auto; padding:35px 35px 35px 35px; border-radius:15px 15px 15px 15px; margin-top: 350px;">
<!-- ================================================================================ -->
<script>
...
<tr>
	<td colspan="2" style="padding-left: 20px;"><div><h4><?php echo htmlentities($ar_packages->nama); ?></h4></div></td>
</tr>	
<tr>
...
<?php
$qry = $this->db->get_where('packages',array('API_packages_id'=>$ar_packages->API_packages_id));
foreach($qry->result() as $row){
	$isDiscnt = $row->discount;  
				...
				<!-- END RIBBON -->
				<?php } ?>
			<img src="<?php echo $ar_packages->gambar; ?>" style="height: 200px; width: 250px; z-index: 0;" />
			</div>
			
		</div>
		
		<br /><br /><br /><br />
		<?php // booking has been sent?> 
		<div><input type="button" name="bookThisPackage" id="bookThisPackage" value="Book Packages" disabled="disabled" /></div>
	</td>
	...
	<td style="width: 60%;">
		...
		<div>
			...
			<tr>
				<td style="padding:5px;font-weight: bold;font-size: 100%;">Adults</td>
				<td style="padding:5px;font-weight: bold;font-size: 100%;">Child(<?php echo $childAgeFrom.' - '.$childAgeTo.' Years old' ?>)</td>
				<td style="padding:5px;font-weight: bold;font-size: 100%;">Tour Date</td>
				<td style="padding:5px; vertical-align: top;">&nbsp;</td>
			</tr>
			<tr>
				<td style="vertical-align: top;padding:5px;" ><select name="adltPax" id="adltPax" style="width:120%; font-size:100%;" ><?php	for($i=1;$i<=50;$i++){	echo '<option value="'.$i.'">'.$i.'</option>';	}?>	</select></td>
				<td style="vertical-align: top;padding:5px;" >
					<div style="display:inline-block;vertical-align:top;">
					<select name="chldPax" id="chldPax" style="width:100%; font-size:100%;" >
						<?php
						for($i=0;$i<=10;$i++){
...
<table>
	...
	?>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" >
				<tr>
					<td colspan="2" style="background: #588ab0;padding-left:10px;color:#fff;"><h5><?php echo htmlentities($row->tour_name); ?></h5></td>
				</tr>
				<tr>
