...
$this->session->set_userdata('bookingUSID', $getDataUSID['usid']);
 ...
 //echo '<script>window.location = "'.base_url().'index.php/transaction/booking_form/sid/'.$getDataUSID['usid'].'/pid/'.$packageID.'"</script>';	
		echo '<script>window.location = "'.base_url().'index.php/transaction/booking_form"</script>';	
}
/* ========================================================================================================= */
/* ========================================================================================================= */	
  ...
  */
	...
	<div style="padding: 5px;">
		...
		echo $myHtml;
			...
			$errMsg = 'Can\'t checkprice for this package';
		}
...
echo '
 	<div>
		<div style="display: block; margin-left: auto; margin-right: auto;width:300px;padding:3px;font-weight:bold;color:#FF0000">'.$errMsg.'</div>	
	</div>';
