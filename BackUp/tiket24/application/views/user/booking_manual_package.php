...
$(document).ready(function(){
	...
	$('#adultPax').change(function() {
		...
		var adultPrice = <?php echo $salePriceAdult; ?>;
	...
	$('#childPax').change(function() {
		...
		var childPrice = <?php echo $salePriceChild; ?>;
...
<table width="100%;">
	<tr>
		<td colspan="2" style="background: #25497d;padding-left:10px;color:#ffffff"><h5><?php echo $fldPckg['nama']; ?></h5></td>
	</tr>
	<tr>
		<td style="vertical-align: top;"><img src="<?php echo $fldPckg['gambar']; ?>" /></td>
		<td style="padding-left: 5px;">
			<!--<form> -->
				
			<table width="100%">
				<tr>
					<td width="250">Adult PAX 
						...
						?>			
					</select> <span> @ <b>SGD</b> <?php echo $salePriceAdult; ?></span>
					<input type="hidden" id="adltTotPrc" value=""  >
					</td>
					<td width="250">Child PAX
						<?php echo form_error('childPax', '<div style="color:red">', '</div>'); ?>
							...
							?>			
						</select> <span> @ <b>SGD</b> <?php echo $salePriceChild; ?></span>
						<input type="hidden" id="chldTotPrc" value="" >
					</td>
					<td width="200"><span id="totAmount" style="padding-left: 3px;">&nbsp;</span></td>
				</tr>
				<tr>
					<td colspan="3">Travel Date 
						<?php echo form_error('tourDate', '<div style="color:red">', '</div>'); ?>
						<input type="text" id="tourDate" name="tourDate" value="" placeholder="Tour Date" style="width:100px;"  /></td>
				</tr>
				<tr>
					<td colspan="3">
					<?php
					$bookingStart = substr($fldPckg['booking_begin'], 0, 10);  
					$bookingEnd = substr($fldPckg['booking_end'], 0, 10);  
					$periodStart = substr($fldPckg['periode_begin'], 0, 10); 
					$periodEnd = substr($fldPckg['periode_end'], 0, 10); 
					?>
	...
	?>
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" >
				<tr>
					<td colspan="2" style="background: #25497d;padding-left:10px;color:#ffffff"><h5><?php echo $row->tour_name; ?></h5></td>
				</tr>
				<tr>
