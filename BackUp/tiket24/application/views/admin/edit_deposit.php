<?php echo form_open_multipart('deposit/edit/'.$isi->deposit_no.'');?>
...
<!--		<td class="field">
	...
	<tr class="form-row">
        ...
        <td class="field">
            <input id="deposit_nominal" type="text" title="Enter Point." size="50" value="<?php echo $isi->nominal; ?>" name="deposit_nominal" dir="rtl" style="width:30%; height:30%;"></input>
		</td>
	</tr>		
</table>
