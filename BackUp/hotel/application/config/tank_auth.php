...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'star-holiday.com ';
$config['webmaster_email'] = 'webmaster@localhost.com';
/*
$config['webmaster_email'] = 'webmaster@localhost.com';
$config['webmaster_email'] = 'admin@tiket24.co.id';
$config['webmaster_email'] = 'admin_wdc@vztore.com';
*/
